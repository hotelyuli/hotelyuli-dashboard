    ...
    Tables: {
      ...
      daily_operations: {
        Row: {
          ...
          housekeeper: string | null; bed_setup: "king" | "two_twin" | "three_twin" | "king_twin" | null; breakfast_to_go_time: string | null; cleaning_status: "pending" | "ready_for_inspection" | "clean";
      ...
      tour_bookings: {
        Row: { id: string; hotel_id: string; operation_date: string; guest_name: string; room_number: string | null; operator_name: string; tour_name: string; tour_date: string; adults: number; children: number; total_price: number; currency: "USD" | "CRC"; commission_amount: number; status: string; payment_method: string | null; receipt_number: string | null; booked_by: string; notes: string | null; created_by: string; created_at: string; updated_at: string; hidden: boolean; hidden_at: string | null };
        ...
        Update: { guest_name?: string; room_number?: string | null; operator_name?: string; tour_name?: string; tour_date?: string; adults?: number; children?: number; total_price?: number; currency?: "USD" | "CRC"; commission_amount?: number; status?: string; payment_method?: string | null; receipt_number?: string | null; booked_by?: string; notes?: string | null; updated_at?: string; hidden?: boolean; hidden_at?: string | null };
        Relationships: [];
      };
      income_entries: {
