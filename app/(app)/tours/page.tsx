...
Total: ${tour.currency} ${tour.total_price}`} /></td></tr>) : <tr><td colSpan={11} className="empty-table-cell">{isToday ? (es ? "No hay tours para hoy." : "No tours for today.") : (es ? `No hay tours para el ${dayLabel}.` : `No tours on ${dayLabel}.`)}</td></tr>}</tbody></table></div></main>;
}
