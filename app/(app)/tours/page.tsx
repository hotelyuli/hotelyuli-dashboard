...
Total: ${tour.currency} ${tour.total_price}`} /></td></tr>) : <tr><td colSpan={11} className="empty-table-cell">{es ? "Todavía no hay tours registrados hoy." : "No tours have been registered today."}</td></tr>}</tbody></table></div></main>;
}
