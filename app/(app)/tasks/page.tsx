...
export default async function TasksPage() {
  ...
  const { data: tasks } = await supabase.from("tasks").select("id,title,room_area,priority,status,due_at,source_event_id").eq("hotel_id", profile?.hotel_id ?? "").in("status", ["open", "in_progress"]).order("created_at", { ascending: false });
