...
export default async function BreakfastPage() {
  ...
  return (
    <main className="dashboard-page">
      <div className="page-heading"><div><p className="eyebrow">{es ? "RESTAURANTE" : "RESTAURANT"}</p><h1>{es ? "Reporte de desayuno" : "Breakfast report"}</h1><p>{es ? `${total} desayunos incluidos para hoy.` : `${total} included breakfast covers today.`}</p></div></div>
