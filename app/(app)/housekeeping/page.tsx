...
export default async function HousekeepingPage() {
  ...
  return (
    <main className="dashboard-page">
      <div className="page-heading"><div><p className="eyebrow">HOUSEKEEPING</p><h1>{es ? "Estado de habitaciones" : "Room status"}</h1><p>{es ? "Vista operativa de las 25 unidades para hoy." : "Today’s operational view of all 25 units."}</p></div></div>
